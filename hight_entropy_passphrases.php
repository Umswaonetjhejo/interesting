<?php
	...
	*/
	...
	//Prepare the Passphrases input
	$passphrasesInput = array(
	...
	$passphrasesInputSize = sizeof($passphrasesInput);
	
	//Loop to check for the number of valid passphrases
	for($z = 0; $z < $passphrasesInputSize; $z++)
	{
		//Put the passphrases in an array
		$n = explode(' ', $passphrasesInput[$z]);
		
		//Get the size of the array of the passphrase
		$arrayNum   = count($n);
		
		//Check for duplicate passphrases
		$arrayCheck = array_count_values($n);
		
		//Check the number of duplicate passphrases
		$duplicatNum = count($arrayCheck);
		
		//Compare the size of array passphrase with the array of duplicate passphrase
		if($arrayNum == $duplicatNum)
		{
			$valid++;
		}
	}
	
	echo "Number of valid passphrases is ".$valid;
?>
